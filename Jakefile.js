        ...
        fs.readFile(input.html, "binary", function(error, data) {
            ...
            require('jsdom/lib/old-api').env({
                html: data,
                    ...
                    docElement = doc.getElementById(adjust.versionId);
                    if (docElement) docElement.innerHTML = package.version;
                    ...
                    var result = '<!doctype html>' + (doc.innerHTML ? doc.innerHTML.trim() : '');
